...
// Table definitions and exports only—NO app/server logic!

export * from "./doctrine_versions";

// Comment out all other table definitions and exports for now
...
// Export all tables here
// export * from "./models/reflections";
// export * from "./models/tasks";
// export * from "./models/contradictions";
// ...add other tables as needed

// If you have enums or static objects, keep them here as well
